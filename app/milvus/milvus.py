...
class Milvus(VectorStore, ABC):
    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        text_field = kwargs.get("text_field", "c" + str(uuid.uuid4().hex))
        collection_name = kwargs.get("collection_name", "c" + str(uuid.uuid4().hex))
        fields = []
    ...
    def as_retriever(self, **kwargs: Any) -> BaseRetriever:
        return MilvusVectorStoreRetriever(vectorstore=self, **kwargs)


class MilvusVectorStoreRetriever(BaseRetriever, BaseModel):
